	...
	public function getAllTemplates() {
		...
		if ( ! empty( $default_templates ) ) {
			$arr_category       = array(
				...
				/*khoapq addition*/
				'category_name'        => __( 'Thim Templates', 'js_composer' ),
				'category_description' => __( 'Chosen templates and discover new layouts with regular template updates from ThimPress team.', 'js_composer' ),
				/*khoapq addition end*/
				'category_weight'      => 11,
			);
			$category_templates = array();
